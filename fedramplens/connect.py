"""Native cognis-connect emit for fedramplens — forward findings to any platform.

Maps fedramplens's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    fedramplens ... --format json | fedramplens-emit --to stix
    fedramplens-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
